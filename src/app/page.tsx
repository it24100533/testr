    ...
    <main role="main" className="flex flex-col min-h-[100dvh] space-y-6 sm:space-y-10 pb-20 sm:pb-8">
      ...
      <section id="skills">
        <div className="flex min-h-0 flex-col gap-y-3">
          ...
          {[ 'DevOps', 'Bash', 'YAML', 'UNIX/Linux', 'Git', 'GitHub','GitLab','OOP Concepts', 'AWS', 'Azure', 'CI/CD', 'Jenkins', 'Docker', 'Kubernetes', 'Microservices', 'Python','Java', 'ML lifecycle',  'Terraform', 'ArgoCD','Ansible', 'Prometheus', 'Grafana', 'TCP/IP', 'Firewalls', 'VPNs', 'Cloud Security', 'ClickUp', 'SQL', 'RDBMS', 'ELK Stack Basics','IaC','FinOps','SSH'].map((skill, id) => (
