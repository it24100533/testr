...
export const DATA = {
  ...
  description:
    "Ravindu Danthanarayana - Software Engineer specializing in DevOps, Cloud Engineering, and AI/ML. Helping machines learn & keeping servers steady • Delivering scalable, reliable systems that drive real business impact",
  cvUrl: "/cv.pdf",
  summary:
