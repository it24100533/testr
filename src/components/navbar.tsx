...
export default function Navbar() {
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-0 z-30 flex origin-bottom h-full max-h-14 md:mx-auto md:mb-4">
      <div className="fixed bottom-0 inset-x-0 h-16 w-full pb-[env(safe-area-inset-bottom)] md:pb-0 bg-white/40 dark:bg-black/25 backdrop-blur-2xl [-webkit-mask-image:linear-gradient(to_top,black,transparent)] [mask-image:linear-gradient(to_top,black,transparent)]" />
